...
- На Android 11+ доступ к `Android/data` и `Android/obb` ограничен системой даже при `All files`.
  Для полноценного доступа к этим каталогам нужен отдельный режим через Shizuku/root.
